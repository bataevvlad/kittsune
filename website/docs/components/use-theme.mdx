...
Kittsune provides hooks and a higher-order component for accessing the current Eva theme and creating theme-aware stylesheets.

## Import

```tsx
import { useTheme, useStyleSheet, withStyles } from '@kittsune/components';
```
...
import { useTheme } from '@kittsune/components';
...
import { useStyleSheet, useTheme } from '@kittsune/components';
