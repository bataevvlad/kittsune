...
```tsx
import { TabBar, TabView, Tab } from '@kittsune/components';
```
...
import { Layout, TabBar, Tab } from '@kittsune/components';
...
```tsx
import React, { useState } from 'react';
import { Layout, TabView, Tab, Text } from '@kittsune/components';
